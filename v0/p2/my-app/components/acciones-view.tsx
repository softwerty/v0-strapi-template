...
const acciones: Accion[] = [
  ...
  },
  {
    ...
    empresa: "Construcciones Fuertes Ltda.",
  ...
  return (
    <div className="space-y-6">
        ...
        <Card key={accion.id} className="w-full">
          ...
          <CardContent>
            <div className="flex justify-between items-center mb-4">
              <span className="text-sm text-muted-foreground">{accion.empresa}</span>
      ...
      <Button className="w-full">
        <PlusCircle className="mr-2 h-4 w-4" /> Agregar Nueva Acción
      </Button>
    </div>
  )
}
